...
## Nao deve fazer para evitar reprovacao automática
...
O repositório já traz as Fases 01 e 02 (backend e frontend), o workflow completo em .claude/ (skills, sub-agents e rules), o CLAUDE.md, o docs/project-plan.md e o compose.yaml do backend com Postgres e Mailpit.
